...
<div class="options" >
  ...
  <option value="Option 2.16">where Code = " "</option>
    ...
    <form class="RE" method="GET">    
        <input class="REQUETE" type="search" name="q" id="inputField" placeholder="Tapter votre requete.." /> <br>
...
<script>
    ...
    select4.addEventListener("change", updateInputField);
      ...
      global $pdo;
            ...
            $recherche = $pdo->query("SELECT Capital FROM country where Name='Afghanistan'");
      ...
      <table class="ta2" style="width:1;">
         <tr>
         <?php if(strpos($q,$all)||strpos($q,$id)||strpos($q,$id2)): ?><th>Id</th> <?php endif ?>
          <?php if(strpos($q,$code)||strpos($q,$all) ): ?><th>Code</th> <?php endif ?>
        <?php  if(strpos($q,$name)||strpos($q,$all)): ?><th>Name</th> <?php endif ?>
          <?php if(strpos($q,$Continent)||strpos($q,$all)): ?><th>Continent</th> <?php endif ?>
          <?php if(strpos($q,$rejion)||strpos($q,$all)): ?><th>Region</th><?php endif ?>
            <?php if(strpos($q,$surfacearea)||strpos($q,$all)): ?><th>SurfaceArea</th> <?php endif ?>
          <?php if(strpos($q,$indepyear)||strpos($q,$all)): ?><th>IndepYear</th><?php endif ?>
         <?php if(strpos($q,$population)||strpos($q,$all)): ?><th>Population</th> <?php endif ?>
          <?php if(strpos($q,$lifeexpectancy)||strpos($q,$all)): ?> <th>Life Expectancy</th><?php endif ?>
            <?php if(strpos($q,$gnp)||strpos($q,$all)): ?><th>GNP</th> <?php endif ?>
          <?php if(strpos($q,$gnpold)||strpos($q,$all)): ?> <th>GNPOLD</th><?php endif ?>
            <?php if(strpos($q,$localname)||strpos($q,$all)): ?><th>Local Name</th><?php endif ?>
          <?php if(strpos($q,$governmentform)||strpos($q,$all)): ?><th>Government Form</th><?php endif ?>
          <?php if(strpos($q,$headofstate)||strpos($q,$all)): ?><th>Head Of State</th><?php endif ?>
            <?php if(strpos($q,$capital)||strpos($q,$all)): ?><th>Capital</th><?php endif ?>
          <?php if(strpos($q,$code2)||strpos($q,$all)): ?><th>Code2</th><?php endif  ?>
        </tr>
      <?php foreach($recherche as $b): ?>
            <tr>
            
            <?php  if(strpos($q,$all) ||strpos($q,$id)||strpos($q,$id2)): ?>  <td><?php  echo $b->id ?></td>  <?php endif ?> 
            <?php if(strpos($q,$code)||strpos($q,$all)): ?> <td><?php echo $b->Code ?></td> <?php endif ?>
            <?php  if(strpos($q,$name)||strpos($q,$all)): ?> <td><?php  echo $b->Name ?></td> <?php endif ?>
            <?php if(strpos($q,$Continent)||strpos($q,$all)): ?>  <td><?php echo $b->Continent ?></td> <?php endif ?>
            <?php if(strpos($q,$rejion)||strpos($q,$all)): ?>  <td><?php echo $b->Region?></td> <?php endif ?>
            <?php if(strpos($q,$surfacearea)||strpos($q,$all)): ?>    <td><?php echo $b->SurfaceArea ?></td> <?php endif ?>
            <?php if(strpos($q,$indepyear)||strpos($q,$all)): ?>    <td><?php echo $b->IndepYear?></td> <?php endif ?>
            <?php if(strpos($q,$population)||strpos($q,$all)): ?>     <td><?php echo $b->Population ?></td> <?php endif ?>
            <?php if(strpos($q,$lifeexpectancy)||strpos($q,$all)): ?>   <td><?php echo $b->LifeExpectancy ?></td> <?php endif ?>
            <?php if(strpos($q,$gnp)||strpos($q,$all)): ?>  <td><?php echo $b->GNP ?></td> <?php endif ?>
            <?php if(strpos($q,$gnpold)||strpos($q,$all)): ?>   <td><?php echo $b->GNPOld ?></td> <?php endif ?>
            <?php if(strpos($q,$localname)||strpos($q,$all)): ?>   <td><?php echo $b->LocalName ?></td> <?php endif ?>
            <?php if(strpos($q,$governmentform)||strpos($q,$all)):?>   <td><?php echo $b->GovernmentForm ?></td> <?php endif ?>
            <?php if(strpos($q,$headofstate)||strpos($q,$all)): ?>   <td><?php echo $b->HeadOfState ?></td> <?php endif ?>
            <?php if(strpos($q,$capital)||strpos($q,$all)): ?>    <td><?php echo $b->Capital ?></td> <?php endif ?>
            <?php if(strpos($q,$code2)||strpos($q,$all)): ?>    <td><?php echo $b->Code2 ?></td> <?php endif ?>
            </div>
      </tr>
        <?php endforeach ?>
        </table>
